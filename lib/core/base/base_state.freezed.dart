...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'BaseState<$T>'))
    ;
}
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'BaseState<$T>.initial'))
    ;
}
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'BaseState<$T>.loading'))
    ;
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $BaseStateCopyWith<T, $Res> {
...
class Empty<T> with DiagnosticableTreeMixin implements BaseState<T> {
  const Empty();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'BaseState<$T>.empty'))
    ;
}
