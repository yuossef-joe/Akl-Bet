...
mixin _$CategoryResponseEntity {
 ...
 int get id; List<CategoryResponseEntity> get subcategories;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoryResponseEntity&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other.subcategories, subcategories));
}


@override
int get hashCode => Object.hash(runtimeType,id,const DeepCollectionEquality().hash(subcategories));

@override
String toString() {
  return 'CategoryResponseEntity(id: $id, subcategories: $subcategories)';
}
...
@useResult
$Res call({
 int id, List<CategoryResponseEntity> subcategories
});
...
/// Create a copy of CategoryResponseEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? subcategories = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  List<CategoryResponseEntity> subcategories)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryResponseEntity() when $default != null:
return $default(_that.id,_that.subcategories);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  List<CategoryResponseEntity> subcategories)  $default,) {final _that = this;
switch (_that) {
case _CategoryResponseEntity():
return $default(_that.id,_that.subcategories);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  List<CategoryResponseEntity> subcategories)?  $default,) {final _that = this;
switch (_that) {
case _CategoryResponseEntity() when $default != null:
return $default(_that.id,_that.subcategories);case _:
  return null;
...
class _CategoryResponseEntity implements CategoryResponseEntity {
  const _CategoryResponseEntity({required this.id, final  List<CategoryResponseEntity> subcategories = const <CategoryResponseEntity>[]}): _subcategories = subcategories;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CategoryResponseEntity&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other._subcategories, _subcategories));
}


@override
int get hashCode => Object.hash(runtimeType,id,const DeepCollectionEquality().hash(_subcategories));
...
/// Create a copy of CategoryResponseEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? subcategories = null,}) {
