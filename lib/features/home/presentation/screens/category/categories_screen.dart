...
class _CategoriesScreenState extends State<CategoriesScreen> {
  ...
  void _fetch() {
    _bloc.add(BaseEvent.fetch(params: CategoryParams()));
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      child: Scaffold(
        ...
        body: BlocListener<CategoryBloc, BaseState<List<CategoryResponseEntity>>>(
          listener: (context, state) {
            // Print to debug console whenever categories load or an error occurs
            if (state is Success<List<CategoryResponseEntity>>) {
          ...
          child:
              BlocBuilder<
                CategoryBloc,
                BaseState<List<CategoryResponseEntity>>
              >(
