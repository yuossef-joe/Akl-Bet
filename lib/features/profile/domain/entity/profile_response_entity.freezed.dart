...
@override
String toString() {
  return 'ProfileResponseEntity(id: $id, firstName: $firstName, lastName: $lastName, email: $email, phone: $phone, image: $image)';
}
...
class _ProfileResponseEntity implements ProfileResponseEntity {
  const _ProfileResponseEntity({required this.id, required this.firstName, required this.lastName, required this.email, required this.phone, this.image});
